            ...
            <div className="w-full max-w-4xl space-y-12">
                ...
                <div className="grid gap-8">
                    ...
                    <div className="group relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-emerald-500/50 transition-all duration-300">
                        <div className="absolute top-0 right-0 -mr-16 -mt-16 h-64 w-64 rounded-full bg-emerald-500/10 blur-3xl group-hover:bg-emerald-500/20 transition-all"></div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row gap-8">
                            <div className="flex-1 space-y-4">
                                ...
                                <h3 className="text-2xl font-bold text-white">Tarjetas de Crédito y Débito</h3>
                                <p className="text-slate-400 leading-relaxed">
                                    Acepta pagos de cualquier parte del mundo. Procesamos Visa, Mastercard y Maestro con la tasa de aprobación más alta del mercado nacional.
                                </p>
                                <ul className="space-y-2 pt-2">
                                    {["Soporte Multimoneda (USD/EUR)", "Protección contra Fraude 3DS", "Tokenización de Tarjetas"].map(item => (
                            ...
                            <div className="flex-1 bg-slate-950/50 rounded-2xl border border-slate-800 p-6 space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-white mt-1">2.9% <span className="text-sm text-slate-400 font-normal">+ $0.30</span></p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Liquidación</p>
                                        <p className="text-xl font-bold text-white mt-1">T+2 <span className="text-sm text-slate-400 font-normal">días hábiles</span></p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Límite por Tx</p>
                                        <p className="text-lg font-medium text-slate-200 mt-1">$2,000.00</p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Contracargos</p>
                                        <p className="text-lg font-medium text-slate-200 mt-1">$15.00</p>
                                    </div>
                                </div>
                            </div>
                        </div>
